        ...
        <form onSubmit={handleCreateAd} className='mt-8 flex flex-col gap-4'>
          <div className='flex flex-col gap-2'>
            ...
            <select
              ...
              defaultValue=""
            >
              <option disabled value="">Select the game that you want to play</option>
          ...
          <div className='grid grid-cols-2 gap-6'>
            <div className='flex flex-col gap-2'>
              ...
              <Input name='yearsPlaying' id='yearsPlaying' type='number' placeholder="It's ok to be ZERO"/>
            </div>

            <div className='flex flex-col gap-2'>
              <label htmlFor='discord'>What's your discord?</label>
              <Input name='discord' id='discord' placeholder="User#1234"/>
            </div>
          </div>
          ...
          <div className='flex flex-row gap-6'>
            <div className='flex flex-col gap-2'>
              <label htmlFor='weekDays'>When do you usually play?</label>
                <ToggleGroup.Root type='multiple' className='flex gap-1' value={weekDays} onValueChange={setWeekDays}>
                  <ToggleGroup.Item value="0" className={`w-8 h-8 rounded ${weekDays.includes('0') ? 'bg-violet-500' : 'bg-zinc-900'}`} title='Sunday'>S</ToggleGroup.Item>
            ...
            <div className='flex flex-col gap-2 flex-1'>
              ...
              <div className='grid grid-cols-2 gap-2'>
                ...
                <Input name='hourEnd' id='hourEnd' type='time' placeholder='Until'/>
              </div>
            </div>
          </div>
          ...
          <label className='mt-2 flex items-center gap-2 text-sm text-white'>
            ...
            I often connect on the voice chat
          </label>
